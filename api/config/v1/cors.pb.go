...
const file_config_v1_cors_proto_rawDesc = "" +
	"\n" +
	"\x14config/v1/cors.proto\x12\tconfig.v1\"\x06\n" +
	"\x04CORSB\x93\x01\n" +
	"\rcom.config.v1B\tCorsProtoP\x01Z2github.com/bpalermo/maestro/api/config/v1;configv1\xa2\x02\x03CXX\xaa\x02\tConfig.V1\xca\x02\tConfig\\V1\xe2\x02\x15Config\\V1\\GPBMetadata\xea\x02\n" +
