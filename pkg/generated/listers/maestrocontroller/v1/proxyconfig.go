...
type ProxyConfigLister interface {
	...
	List(selector labels.Selector) (ret []*maestrocontrollerv1.ProxyConfig, err error)
...
type proxyConfigLister struct {
	listers.ResourceIndexer[*maestrocontrollerv1.ProxyConfig]
}

// NewProxyConfigLister returns a new ProxyConfigLister.
func NewProxyConfigLister(indexer cache.Indexer) ProxyConfigLister {
	return &proxyConfigLister{listers.New[*maestrocontrollerv1.ProxyConfig](indexer, maestrocontrollerv1.Resource("proxyconfig"))}
}

// ProxyConfigs returns an object that can list and get ProxyConfigs.
func (s *proxyConfigLister) ProxyConfigs(namespace string) ProxyConfigNamespaceLister {
	return proxyConfigNamespaceLister{listers.NewNamespaced[*maestrocontrollerv1.ProxyConfig](s.ResourceIndexer, namespace)}
}
...
type ProxyConfigNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*maestrocontrollerv1.ProxyConfig, error)
